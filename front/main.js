...
const routes = [
    ...
    {
        path: 'config',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_config_config_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./config/config.module */ 4032)).then(m => m.ConfigPageModule)
    },
    {
        path: '',
        redirectTo: 'config',
...
const serverIP = 'https://192.168.1.105:3000';
/*
