...
let EventService = class EventService {
    static get(evento) {
        if (!this.emitters[evento])
            this.emitters[evento] = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.EventEmitter();
        return this.emitters[evento];
    }
};
EventService.emitters = {};
...
/***/ 8819:
/*!***************************************************!*\
  !*** ./src/app/services/evento-shared.service.ts ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "EventoSharedService": () => (/* binding */ EventoSharedService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 4929);
...
let EventoSharedService = class EventoSharedService {
    constructor() {
        this.configSource = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(Object);
        this.currentConfig = this.configSource.asObservable();
    }
    setConfig(config) {
        this.configSource.next(config);
    }
};
EventoSharedService.ctorParameters = () => [];
EventoSharedService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
let HttpService = class HttpService {
    constructor(http, loadingController, toastController) {
        ...
        this.url = src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.serverIP;
        this.rodaApi = 'https://192.168.36.36:3000';
        _event_service__WEBPACK_IMPORTED_MODULE_1__.EventService.get('apiUrl').subscribe((data) => {
    ...
    sendVideo(formData) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            }), (err) => (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
                setTimeout(() => {
                    this.loadingController.dismiss();
                }, 300);
                const toast = yield this.toastController.create({
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_var_www_html_videoSpin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_var_www_html_videoSpin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_var_www_html_videoSpin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
